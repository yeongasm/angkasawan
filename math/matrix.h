...
namespace math
{
    ...
    struct Matrix3x3
    {
        ...
        constexpr Matrix3x3(const Vector3<T>& a, const Vector3<T>& b, const Vector3<T>& c) :
        ...
        static constexpr Vector3<T> get_x_vector(const Matrix3x3& m)
        {
            return Vector3<T>(m.m00, m.m01, m.m02);
        }

        static constexpr Vector3<T> get_y_vector(const Matrix3x3& m)
        {
            return Vector3<T>(m.m10, m.m11, m.m12);
        }

        static constexpr Vector3<T> get_z_vector(const Matrix3x3& m)
    ...
    struct Matrix4x4
    {
        ...
        constexpr Matrix4x4(const Vector4<T>& a, const Vector4<T>& b, const Vector4<T>& c, const Vector4<T>& d) :
        ...
        constexpr Matrix4x4(const Matrix3x3<T>& m) :
        ...
        static constexpr Vector4<T> get_x_vector(const Matrix4x4& m)
        {
            return Vector4<T>(m.m00, m.m01, m.m02, m.m03);
        }

        static constexpr Vector4<T> get_y_vector(const Matrix4x4& m)
        {
            return Vector4<T>(m.m10, m.m11, m.m12, m.m13);
        }

        static constexpr Vector4<T> get_z_vector(const Matrix4x4& m)
        {
            return Vector4<T>(m.m20, m.m21, m.m22, m.m23);
        }

        static constexpr Vector4<T> get_w_vector(const Matrix4x4& m)
        {
