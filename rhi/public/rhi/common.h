...
RHI_API auto is_depth_format(Format format) -> bool;
RHI_API auto is_stencil_format(Format format) -> bool;
RHI_API auto get_image_format_string(Format format) -> std::string_view;
}
