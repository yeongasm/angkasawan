...
core::OSEvent handle_mouse_input(HWND hWnd, LPARAM lParam)
{
	core::OSEvent ev{};
	ev.windowHandle = hWnd;
	...
	if (wheel_delta)
	{
		ev.event = core::OSEvent::Type::Mouse_Wheel;
		ev.mouseWheel.offset = static_cast<float32>(wheel_delta / WHEEL_DELTA);
		return ev;
	}

	ev.event = core::OSEvent::Type::Mouse_Button;

	if (flags & RI_MOUSE_LEFT_BUTTON_DOWN)
	{
		ev.mouseButton.button = core::IOMouseButton::Io_Mouse_Button_Left;
	...
	{
		ev.mouseButton.button = core::IOMouseButton::Io_Mouse_Button_Right;
		ev.mouseButton.down = true;
	}
	...
	{
		ev.mouseButton.button = core::IOMouseButton::Io_Mouse_Button_Middle;
		ev.mouseButton.down = true;
	}
	...
	{
		ev.mouseButton.button = core::IOMouseButton::Io_Mouse_Button_Extra1;
		ev.mouseButton.down = true;
	}
	...
	{
		ev.mouseButton.button = core::IOMouseButton::Io_Mouse_Button_Extra2;
		ev.mouseButton.down = true;
	}
	...
	if (x != 0 || y != 0)
	{
		...
		ev.event = core::OSEvent::Type::Mouse_Move;
		ev.mouseMove.x = p.x;
		ev.mouseMove.y = p.y;
	}
